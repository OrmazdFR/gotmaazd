...
Changes applied to original file :
	- custom variables (clientID, clientSecret, scopes, redirectURL, cookieSecret)
	- custom server port
	- replaced some log.Printf by fmt.Printf
*/
...
var (
	...
	cookieSecret = []byte("thatsasecret")
...
func getAuth() {
	...
	fmt.Println("Started running on http://localhost:1342")
